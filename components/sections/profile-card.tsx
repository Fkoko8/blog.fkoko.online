      ...
      <div className="card-editorial grain flex h-full flex-col p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="font-heading text-xl font-bold uppercase tracking-tight">{profile.displayName}</h3>
        ...
        <div className="mt-4 border-l-2 border-accent/50 pl-3">
          <p className="font-hand text-lg text-foreground/80">&ldquo;{profile.quote}&rdquo;</p>
        </div>
